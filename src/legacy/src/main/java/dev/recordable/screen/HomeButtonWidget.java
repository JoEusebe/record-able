...
public final class HomeButtonWidget {
    ...
    public static ButtonWidget create(Screen hostScreen, int x, int y) {
        ...
        button.setTooltip(Tooltip.of(Text.literal("Record-able Video Collection")));
        return button;
    }
    ...
    private static final class LogoButton extends ButtonWidget {
        ...
        protected void renderWidget(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
            ...
            context.drawTexture(ICON, iconX, iconY, 0.0F, 0.0F, ICON_SIZE, ICON_SIZE, ICON_SIZE, ICON_SIZE);
        }
    }
}
