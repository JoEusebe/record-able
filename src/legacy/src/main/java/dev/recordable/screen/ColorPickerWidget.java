...
public final class ColorPickerWidget extends ClickableWidget {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        boolean handled = this.textField.mouseClicked(mouseX, mouseY, button);
    ...
    public boolean mouseReleased(double mouseX, double mouseY, int button) {
        return this.textField.mouseReleased(mouseX, mouseY, button) || super.mouseReleased(mouseX, mouseY, button);
    }

    @Override
    public boolean mouseDragged(double mouseX, double mouseY, int button, double deltaX, double deltaY) {
        return this.textField.mouseDragged(mouseX, mouseY, button, deltaX, deltaY) || super.mouseDragged(mouseX, mouseY, button, deltaX, deltaY);
    }
