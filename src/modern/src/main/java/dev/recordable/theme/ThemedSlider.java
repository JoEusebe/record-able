...
public class ThemedSlider extends AbstractSliderButton {
    ...
    public ThemedSlider(int x, int y, int w, int h, String labelFormat,
        ...
        super(x, y, w, h, Component.literal(String.format(labelFormat, (int) currentVal)),
    ...
    protected void updateMessage() {
        ...
        this.setMessage(Component.literal(String.format(labelFormat, (int) val)));
    }
     ...
     */
    public static void drawThemedBar(GuiGraphicsExtractor context, int x, int y, int w, int h,
