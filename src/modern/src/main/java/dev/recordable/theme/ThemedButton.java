 ...
 * Uses standard Button internally for compatibility with Minecraft 1.21.1 API.
 */
public final class ThemedButton {
    ...
    /**
     * Creates a standard Button using the builder API.
     */
    public static Button create(int x, int y, int w, int h, Component msg, Button.OnPress onPress) {
     ...
     */
    public static void drawThemedButtonRect(GuiGraphicsExtractor context, int x, int y, int w, int h,
