...
public final class ReplayBuffer {
     ...
     */
    public void saveBuffer(Minecraft client) {
        if (!active.get()) {
    ...
    private void saveFramesToFile(Minecraft client, FrameRef[] frames) throws Exception {
        RecordableConfig config = RecordableConfig.get();
        ...
        // frame writes below and deadlocks the save (same failure mode documented in
        // KillClipBuffer.encode()).
        ...
        }, "Record-able Replay Buffer FFmpeg Log");
