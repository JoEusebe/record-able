...
/**
 * Hidden easter-egg "thank you" screen (modern, MC 26.x+).
 *
...
public final class ThankYouScreen extends Screen {
    ...
    public ThankYouScreen(Screen parent) {
        super(Component.literal("Thank you so much"));
        this.parent = parent;
    }
    ...
    protected void init() {
        ...
        if (this.song == null && this.minecraft != null) {
            try {
                SoundEvent event = SoundEvent.createVariableRangeEvent(VersionHelper.modId("thank_you"));
                this.song = SimpleSoundInstance.forUI(event, 1.0f);
                this.minecraft.getSoundManager().play(this.song);
            } catch (Throwable ignored) {
            }
        }
    }
    ...
    public void extractRenderState(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
        ...
        context.blit(RenderPipelines.GUI_TEXTURED, LILLY, imgX, imgY, 0.0F, 0.0F,
                imgW, imgH, LILLY_W, LILLY_H, LILLY_W, LILLY_H);

        // Title above the picture.
        context.centeredText(this.font, Component.literal("Thank you so much"),
                cx, titleY, tc.headerText);

        // Caption below the picture.
        context.centeredText(this.font, Component.literal("Lilly says hi"),
        ...
        context.centeredText(this.font, Component.literal("Close"),
        ...
        context.centeredText(this.font,
                Component.literal("Go to menu and say bye to Lilly"),
    ...
    private void renderSynthwaveBackground(GuiGraphicsExtractor context) {
        // Sky gradient.
    ...
    private void closeEgg() {
        ...
        if (this.song != null && this.minecraft != null) {
            try {
                this.minecraft.getSoundManager().stop(this.song);
            } catch (Throwable ignored) {
            }
        }
    ...
    public boolean mouseClicked(MouseButtonEvent click, boolean doubleClick) {
        ...
        if (System.currentTimeMillis() - this.openedAt > 250) {
            computeLayout(this.font.lineHeight);
    ...
    private void disableEasterEgg() {
        ...
        if (this.minecraft != null) {
            ...
            this.minecraft.setScreenAndShow(new VideoCollectionScreen(this.parent));
