...
/**
 * "Test Capture" diagnostic screen (modern variant).
 *
...
public final class CaptureDiagnosticsScreen extends Screen {
    ...
    public CaptureDiagnosticsScreen(Screen parent) {
        super(Component.literal("Capture Diagnostics"));
        this.parent = parent;
    }
    ...
    protected void init() {
        ...
        this.addRenderableWidget(Button.builder(
                Component.literal("Run Test Again"),
        ...
        this.addRenderableWidget(Button.builder(
                ...
                button -> onClose()
        ).bounds(startX + buttonWidth + gap, buttonY, 110, 20).build());
    }
    ...
    private void rebuildLines() {
        ...
        if (client != null && client.getWindow() != null) {
            winW = client.getWindow().getWidth();
            winH = client.getWindow().getHeight();
            try {
                guiScale = (int) client.getWindow().getGuiScale();
    ...
    public void extractRenderState(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < lines.size(); i++) {
            ...
            context.text(this.font, Component.literal(text), textLeft, y, line.color, true);
        }
