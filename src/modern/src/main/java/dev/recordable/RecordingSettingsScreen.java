...
public final class RecordingSettingsScreen extends Screen {
    ...
    public RecordingSettingsScreen(Screen parent) {
        super(Component.literal("Recording Settings"));
        this.parent = parent;
    }
    ...
    protected void init() {
        ...
        addRenderableWidget(deferredToggle);
        y += ROW_SPACING;
        ...
        addRenderableWidget(captureFpsButton);
        ...
        addRenderableWidget(autoRenderToggle);
        y += ROW_SPACING;
        ...
        addRenderableWidget(keepFramesToggle);
        y += ROW_SPACING;
        ...
        addRenderableWidget(ThemedButton.create(startX, btnY, btnW, WIDGET_HEIGHT,
                Component.literal("Save and Close"), b -> saveAndClose()));
        addRenderableWidget(ThemedButton.create(startX + btnW + btnGap, btnY, btnW, WIDGET_HEIGHT,
                Component.literal("Cancel"), b -> onClose()));
    }

    private Component captureFpsLabel()    { return Component.literal("Capture FPS: " + this.captureFps); }
    private Component targetFpsLabel()     { return Component.literal("Target FPS: " + this.targetFps); }
    private Component interpolationLabel() { return Component.literal("Interp: " + displayInterpolation(this.interpolation)); }
    ...
    private static Tooltip tip(String s) {
        return Tooltip.create(Component.literal(s));
    }
    ...
    public void extractRenderState(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
        ...
        int textX = panelX + 12;
        int line = 11;
        context.text(tr, Component.literal("\u00a77Captures low-FPS frames while you play to keep FPS high,"),
                textX, infoY, 0xFFB0B0B0);
        context.text(tr, Component.literal("\u00a77then renders a smooth video afterwards. Trade-off: uses"),
                textX, infoY + line, 0xFFB0B0B0);
        context.text(tr, Component.literal("\u00a77disk space and extra time after recording."),
                textX, infoY + line * 2, 0xFFB0B0B0);
