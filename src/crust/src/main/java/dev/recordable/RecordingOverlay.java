...
public final class RecordingOverlay {
    ...
    /**
     * Registers the HUD overlay renderer using {@code HudRenderCallback}.
     *
     * <p>This crust build targets MC 1.21.2-1.21.5 where
     * {@code HudElementRegistry} is not yet available.</p>
     */
    public static void register() {
        ...
        // Register HUD overlay via HudRenderCallback (MC 1.21.2-1.21.5).
    ...
    private static void renderMousePointer(DrawContext context, MinecraftClient client,
        ...
        context.drawTexture(RenderLayer::getGuiTextured, OS_CURSOR_TEXTURE, drawX, drawY, 0.0f, 0.0f,
    ...
    private static void renderImageWatermark(DrawContext context, MinecraftClient client,
        ...
        if (slot.rotation != 0) {
            ...
            HudMat.translate(context, -cx, -cy);
            context.drawTexture(RenderLayer::getGuiTextured, tex.id, x, y, 0.0f, 0.0f,
