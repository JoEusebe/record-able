 ...
 * using Minecraft's {@link DrawContext} primitives.
 *
...
public final class FilterPreviewRenderer {
    ...
    private static void renderVhs(DrawContext context, int w, int h, float t) {
    ...
    private static void renderLcdMoire(DrawContext context, int w, int h, float t) {
    ...
    private static void renderCrt(DrawContext context, int w, int h, float t) {
