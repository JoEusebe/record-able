...
/**
 * Hidden easter-egg "thank you" screen (sandwich, MC 1.20.5-1.21.11).
 *
...
public final class ThankYouScreen extends Screen {
    ...
    protected void init() {
        ...
        if (this.song == null && this.client != null) {
            try {
                ...
                this.song = PositionedSoundInstance.music(event);
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawTexture(RenderPipelines.GUI_TEXTURED, LILLY, imgX, imgY, 0.0F, 0.0F,
