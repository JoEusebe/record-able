...
public final class OverlayPositionScreen extends Screen {
    ...
    private static final int GUIDE_COLOR      = 0x33FFFFFF;
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        // potential z-ordering / render-state issues where the dirt-texture
        // background can cover subsequently batched DrawContext.fill() calls.
        ...
        dev.recordable.HudMat.push(context);
        dev.recordable.HudMat.scale(context, overlayScale, overlayScale);
        ...
        dev.recordable.HudMat.pop(context);
