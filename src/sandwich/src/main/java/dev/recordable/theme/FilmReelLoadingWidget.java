...
public class FilmReelLoadingWidget extends ClickableWidget {
    ...
    protected void renderWidget(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (statusText != null) {
            ...
            context.drawCenteredTextWithShadow(mc.textRenderer, statusText, x + w / 2, y + 3, colors.textSecondary);
        }
    }

    private void drawSpinningReel(DrawContext context, int cx, int cy, int radius, long tick, ThemeColors colors) {
    ...
    private static void ctx(DrawContext context, int x1, int y1, int x2, int y2, int color) {
