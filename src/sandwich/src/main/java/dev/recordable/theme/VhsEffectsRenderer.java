...
public final class VhsEffectsRenderer {
     ...
     */
    public static void renderOverPanel(DrawContext ctx, int left, int top, int right, int bottom) {
    ...
    public static void renderScanlines(DrawContext ctx, int left, int top, int right, int bottom, int color) {
    ...
    public static void renderFilmGrain(DrawContext ctx, int left, int top, int right, int bottom, int color) {
        if ((color & 0xFF000000) == 0) return;
        int w = right - left;
        int h = bottom - top;
    ...
    public static void renderGlitchBars(DrawContext ctx, int left, int top, int right, int bottom, int color) {
        if ((color & 0xFF000000) == 0) return;
    ...
    public static void renderVignette(DrawContext ctx, int left, int top, int right, int bottom, int color) {
        if ((color & 0xFF000000) == 0) return;
        int w = right - left;
        int h = bottom - top;
    ...
    public static void renderTrackingNoise(DrawContext ctx, int left, int top, int right, int lineCount) {
    ...
    public static void renderSprocketHoles(DrawContext ctx, int x, int top, int bottom, int color) {
        int spacing = 18;
        int holeW = 6;
        int holeH = 4;
    ...
    public static void renderFilmStripBorders(DrawContext ctx, int left, int top, int right, int bottom, int borderWidth) {
        ThemeColors colors = ThemeEngine.get().colors();
    ...
    public static void renderTapeLoadingBar(DrawContext ctx, int left, int y, int right, float progress) {
        ThemeColors colors = ThemeEngine.get().colors();
        int h = 3;
    ...
    public static void renderVcrPlayBadge(DrawContext ctx, net.minecraft.client.font.TextRenderer textRenderer, int x, int y) {
        ThemeColors colors = ThemeEngine.get().colors();
    ...
    /** REC blinking dot. */
    public static void renderRecDot(DrawContext ctx, int x, int y, int radius) {
        ThemeColors colors = ThemeEngine.get().colors();
    ...
    private static void renderGalaxyStars(DrawContext ctx, int left, int top, int right, int bottom, ThemeColors colors) {
        int w = right - left;
        int h = bottom - top;
        if (w <= 0 || h <= 0) {
            return;
    ...
    private static void renderGalaxyShootingStar(DrawContext ctx, int left, int top, int right, int bottom, ThemeColors colors, int glowIntensity) {
        int w = right - left;
        int h = bottom - top;
        if (w < 40 || h < 28) {
            return;
